...
const VideoLink = () => {
	...
	return (
		<div className="text-[.9rem] flex items-center justify-between bg-light_gray text-light_white dark:bg-light_white dark:text-light_gray rounded-sm overflow-hidden">
